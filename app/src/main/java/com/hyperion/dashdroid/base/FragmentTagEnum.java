...
public enum FragmentTagEnum {
	...
	RADIO_HOME("RADIO_HOME_FRAGMENT_TAG"), RADIO_CATEGORIES("RADIO_CATEGORY_FRAGMENT_TAG"), RADIO_POPULAR("RADIO_POPULAR_FRAGMENT_TAG"), RADIO_COUNTRIES("RADIO_COUNTRY_FRAGMENT_TAG");
